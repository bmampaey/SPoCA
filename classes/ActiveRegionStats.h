#pragma once
#ifndef ActiveRegionStats_H
#define ActiveRegionStats_H
...
std::vector<ActiveRegionStats*> getActiveRegionStats(const ColorMap* colorizedComponentsMap, const EUVImage* image);
FitsFile& writeRegions(FitsFile& file, const std::vector<ActiveRegionStats*>& ActiveRegionStats);
