...
#pragma once
 ...
 namespace dsr{
   ...
   public:
     ...
     void new_unsigned_long(const char *value_name, const char *description,
                           unsigned long &dest);
     void new_optional_unsigned_long(const char *value_name, const char *description,
                                 unsigned long &dest);
     void new_named_unsigned_long(char key, const char *long_name,
                                    const char *value_name, const char *description,
                                    unsigned long &dest);
 ...
 #define ArgumentHelper_BASICS(ah) ah.set_author("Daniel Russel, drussel@stanford.edu");\
