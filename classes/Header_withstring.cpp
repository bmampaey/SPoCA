...
template string Header::get<string>(const string& key)const;
template string Header::get<string>(const char* key)const;
template void Header::set<string>(const string& key, const string& value);
template void Header::set<string>(const char* key, const string& value);
...
template void Header::set<string>(const string& key, const string& value, const string& comment);
template void Header::set<string>(const char* key, const string& value, const char* comment);
