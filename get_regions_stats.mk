...
objects/CoronalHoleStats.o : get_regions_stats.mk classes/CoronalHoleStats.cpp classes/constants.h classes/Region.h classes/Coordinate.h classes/EUVImage.h classes/ColorMap.h classes/FitsFile.h
	$(CC) -c $(CFLAGS) $(DFLAGS) classes/CoronalHoleStats.cpp -o objects/CoronalHoleStats.o

objects/FitsFile.o : get_regions_stats.mk classes/FitsFile.cpp classes/fitsio.h classes/longnam.h classes/tools.h classes/constants.h classes/Header.h
...
objects/Region.o : get_regions_stats.mk classes/Region.cpp classes/constants.h classes/Coordinate.h classes/ColorMap.h classes/FitsFile.h
	$(CC) -c $(CFLAGS) $(DFLAGS) classes/Region.cpp -o objects/Region.o

objects/ActiveRegionStats.o : get_regions_stats.mk classes/ActiveRegionStats.cpp classes/constants.h classes/Region.h classes/Coordinate.h classes/EUVImage.h classes/ColorMap.h classes/FitsFile.h
	$(CC) -c $(CFLAGS) $(DFLAGS) classes/ActiveRegionStats.cpp -o objects/ActiveRegionStats.o

objects/RegionStats.o : get_regions_stats.mk classes/RegionStats.cpp classes/constants.h classes/Region.h classes/Coordinate.h classes/EUVImage.h classes/ColorMap.h classes/FitsFile.h
...
objects/SunImage.o : get_regions_stats.mk classes/SunImage.cpp classes/Image.h classes/Coordinate.h classes/Header.h classes/FitsFile.h
