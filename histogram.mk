...
all:bin/histogram.x
clean: rm bin/histogram.x objects/histogram.o objects/FeatureVector.o objects/mainutilities.o objects/Header.o objects/ColorMap.o objects/SunImage.o objects/FitsFile.o objects/tools.o objects/Coordinate.o objects/Image.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/ArgumentHelper.o objects/EUVImage.o


bin/histogram.x : histogram.mk objects/histogram.o objects/FeatureVector.o objects/mainutilities.o objects/Header.o objects/ColorMap.o objects/SunImage.o objects/FitsFile.o objects/tools.o objects/Coordinate.o objects/Image.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/ArgumentHelper.o objects/EUVImage.o
	$(CC) $(CFLAGS) $(DFLAGS) objects/histogram.o objects/FeatureVector.o objects/mainutilities.o objects/Header.o objects/ColorMap.o objects/SunImage.o objects/FitsFile.o objects/tools.o objects/Coordinate.o objects/Image.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/ArgumentHelper.o objects/EUVImage.o $(LFLAGS) -o bin/histogram.x

objects/histogram.o : histogram.mk utilities/histogram.cpp classes/EUVImage.h classes/ArgumentHelper.h classes/mainutilities.h classes/HistogramFeatureVector.h classes/FeatureVector.h
...
objects/mainutilities.o : histogram.mk classes/mainutilities.cpp classes/FeatureVector.h classes/EUVImage.h classes/EITImage.h classes/EUVIImage.h classes/AIAImage.h classes/SWAPImage.h classes/HMIImage.h classes/ColorMap.h classes/Header.h
	$(CC) -c $(CFLAGS) $(DFLAGS) classes/mainutilities.cpp -o objects/mainutilities.o

objects/Header.o : histogram.mk classes/Header.cpp 
	$(CC) -c $(CFLAGS) $(DFLAGS) classes/Header.cpp -o objects/Header.o

objects/ColorMap.o : histogram.mk classes/ColorMap.cpp classes/Header.h classes/SunImage.h classes/gradient.h
