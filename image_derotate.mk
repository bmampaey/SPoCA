...
clean: rm bin/image_derotate.x objects/image_derotate.o objects/mainutilities.o objects/ColorMap.o objects/Header.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/EUVImage.o objects/Coordinate.o objects/FeatureVector.o objects/ArgumentHelper.o objects/SunImage.o objects/FitsFile.o objects/Image.o objects/tools.o


bin/image_derotate.x : image_derotate.mk objects/image_derotate.o objects/mainutilities.o objects/ColorMap.o objects/Header.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/EUVImage.o objects/Coordinate.o objects/FeatureVector.o objects/ArgumentHelper.o objects/SunImage.o objects/FitsFile.o objects/Image.o objects/tools.o
	$(CC) $(CFLAGS) $(DFLAGS) objects/image_derotate.o objects/mainutilities.o objects/ColorMap.o objects/Header.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/EUVImage.o objects/Coordinate.o objects/FeatureVector.o objects/ArgumentHelper.o objects/SunImage.o objects/FitsFile.o objects/Image.o objects/tools.o $(LFLAGS) -o bin/image_derotate.x
...
objects/mainutilities.o : image_derotate.mk classes/mainutilities.cpp classes/FeatureVector.h classes/EUVImage.h classes/EITImage.h classes/EUVIImage.h classes/AIAImage.h classes/SWAPImage.h classes/HMIImage.h classes/ColorMap.h
	$(CC) -c $(CFLAGS) $(DFLAGS) classes/mainutilities.cpp -o objects/mainutilities.o

objects/ColorMap.o : image_derotate.mk classes/ColorMap.cpp classes/Header.h classes/SunImage.h
...
objects/SunImage.o : image_derotate.mk classes/SunImage.cpp classes/Image.h classes/Coordinate.h classes/Header.h classes/FitsFile.h
	$(CC) -c $(CFLAGS) $(DFLAGS) classes/SunImage.cpp -o objects/SunImage.o

objects/FitsFile.o : image_derotate.mk classes/FitsFile.cpp classes/fitsio.h classes/longnam.h classes/tools.h classes/constants.h classes/Header.h
