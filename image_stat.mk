...
clean: rm bin/image_stat.x objects/image_stat.o objects/mainutilities.o objects/ColorMap.o objects/Header.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/EUVImage.o objects/Coordinate.o objects/FeatureVector.o objects/ArgumentHelper.o objects/SunImage.o objects/FitsFile.o objects/Image.o objects/tools.o


bin/image_stat.x : image_stat.mk objects/image_stat.o objects/mainutilities.o objects/ColorMap.o objects/Header.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/EUVImage.o objects/Coordinate.o objects/FeatureVector.o objects/ArgumentHelper.o objects/SunImage.o objects/FitsFile.o objects/Image.o objects/tools.o
	$(CC) $(CFLAGS) $(DFLAGS) objects/image_stat.o objects/mainutilities.o objects/ColorMap.o objects/Header.o objects/HMIImage.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/EUVImage.o objects/Coordinate.o objects/FeatureVector.o objects/ArgumentHelper.o objects/SunImage.o objects/FitsFile.o objects/Image.o objects/tools.o $(LFLAGS) -o bin/image_stat.x
...
objects/mainutilities.o : image_stat.mk classes/mainutilities.cpp classes/FeatureVector.h classes/EUVImage.h classes/EITImage.h classes/EUVIImage.h classes/AIAImage.h classes/SWAPImage.h classes/HMIImage.h classes/ColorMap.h
	$(CC) -c $(CFLAGS) $(DFLAGS) classes/mainutilities.cpp -o objects/mainutilities.o

objects/ColorMap.o : image_stat.mk classes/ColorMap.cpp classes/Header.h classes/SunImage.h
