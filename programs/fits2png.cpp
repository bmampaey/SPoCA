//! This program convert a sun image FITS file to a png image, applying some contrast enhancement.
/*!
@page fits2png png.x
...
@section usage Usage
<tt> bin/fits2png.x [-option optionvalue ...] fitsFile</tt>

@param fitsFile	Path to the sun image FITS file to be converted
...
int main(int argc, const char **argv)
{
	...
	string programDescription = "This program convert a sun image FITS file to a png image, applying some contrast enhancement.";
	programDescription+="\nVersion: 3.0";
	programDescription+="\nAuthor: Benjamin Mampaey, benjamin.mampaey@sidc.be";
	...
	args["fitsFile"] = ArgParser::PositionalParameter("Path to the sun image FITS file to be converted");
	...
	// We convert the FITS file to PNG
