...
all:bin/uncompres.x
clean: rm bin/uncompres.x objects/uncompres.o objects/mainutilities.o objects/HMIImage.o objects/Header.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/FeatureVector.o objects/ArgumentHelper.o objects/FitsFile.o objects/tools.o objects/ColorMap.o objects/SunImage.o objects/Coordinate.o objects/Image.o objects/EUVImage.o


bin/uncompres.x : uncompres.mk objects/uncompres.o objects/mainutilities.o objects/HMIImage.o objects/Header.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/FeatureVector.o objects/ArgumentHelper.o objects/FitsFile.o objects/tools.o objects/ColorMap.o objects/SunImage.o objects/Coordinate.o objects/Image.o objects/EUVImage.o
	$(CC) $(CFLAGS) $(DFLAGS) objects/uncompres.o objects/mainutilities.o objects/HMIImage.o objects/Header.o objects/SWAPImage.o objects/AIAImage.o objects/EUVIImage.o objects/EITImage.o objects/FeatureVector.o objects/ArgumentHelper.o objects/FitsFile.o objects/tools.o objects/ColorMap.o objects/SunImage.o objects/Coordinate.o objects/Image.o objects/EUVImage.o $(LFLAGS) -o bin/uncompres.x
...
objects/mainutilities.o : uncompres.mk classes/mainutilities.cpp classes/FeatureVector.h classes/EUVImage.h classes/EITImage.h classes/EUVIImage.h classes/AIAImage.h classes/SWAPImage.h classes/HMIImage.h classes/ColorMap.h
...
objects/ColorMap.o : uncompres.mk classes/ColorMap.cpp classes/Header.h classes/SunImage.h
